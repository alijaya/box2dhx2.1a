...
class B2Shape
 {
	...
	*/
	...
	public static function TestOverlap(shape1:B2Shape, transform1:B2Transform, shape2:B2Shape, transform2:B2Transform):Bool
	{
		...
		return output.distance  < 10.0 * box2D.common.math.B2Math.MIN_VALUE;
	}
	...
	*/
	//enum B2ShapeType
	//{
		public static var e_unknownShape:Int = 	-1;
		public static var e_circleShape:Int = 	0;
		public static var e_polygonShape:Int = 	1;
		public static var e_edgeShape:Int =       2;
		public static var e_shapeTypeCount:Int = 	3;
	//}
