...
class B2ContactSolver
{
	...
	public function Initialize(step:B2TimeStep, contacts:Vector<B2Contact>, contactCount:Int, allocator:Dynamic):Void
	{
		...
		while ((cast m_constraints.length) < m_constraintCount)
		{
...
//#endif
	...
	public var m_constraints:Vector<B2ContactConstraint>;
