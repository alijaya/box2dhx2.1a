	...
	*/
	...
	override function InitVelocityConstraints(step:B2TimeStep) : Void{
		...
		// Compute motor Jacobian and effective mass.
		{
			...
			m_motorMass = m_motorMass > box2D.common.math.B2Math.MIN_VALUE?1.0 / m_motorMass:0.0;
		}
	...
	public var m_s1:Float;
	public var m_s2:Float;
	public var m_a1:Float;
	public var m_a2:Float;
	
	public var m_K:B2Mat22 ;
	public var m_impulse:B2Vec2 ;

	public var m_motorMass:Float;			// effective mass for motor/limit translational constraint.
	public var m_motorImpulse:Float;
