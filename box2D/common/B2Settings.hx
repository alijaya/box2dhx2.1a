...
class B2Settings {
    ...
    * The current version of box2D
    */
    public static var VERSION:String = "2.1alpha";

	public static var USHRT_MAX:Int = 0x0000ffff;
     ...
     */
	public static var b2_maxManifoldPoints:Int = 2;
	 ...
	 * This is in meters.
	 */
	public static var b2_aabbExtension:Float = 0.1;
	 ...
	 */
	public static var b2_aabbMultiplier:Float = 2.0;
	 ...
	 */
	public static var b2_polygonRadius:Float = 2.0 * b2_linearSlop;
	...
	*/
	public static var b2_maxTOIContactsPerIsland:Int = 32;
	
	/**
	* Maximum number of joints to be handled to solve a TOI island.
	*/
	public static var b2_maxTOIJointsPerIsland:Int = 32;
	
	/**
	* A velocity threshold for elastic collisions. Any collision with a relative linear
	* velocity below this threshold will be treated as inelastic.
	*/
	public static var b2_velocityThreshold:Float = 1.0;		// 1 m/s
	
	/**
	* The maximum linear position correction used when solving constraints. This helps to
	* prevent overshoot.
	*/
	public static var b2_maxLinearCorrection:Float = 0.2;	// 20 cm
	...
	*/
	public static var b2_maxTranslation:Float = 2.0;
	public static var b2_maxTranslationSquared:Float = b2_maxTranslation * b2_maxTranslation;
	
	/**
	* The maximum angular velocity of a body. This limit is very large and is used
	* to prevent numerical problems. You shouldn't need to adjust this.
	*/
	public static var b2_maxRotation:Float = 0.5 * b2_pi;
	public static var b2_maxRotationSquared:Float = b2_maxRotation * b2_maxRotation;
	...
	* to overshoot.
	*/
	public static var b2_contactBaumgarte:Float = 0.2;
	...
	*/
	public static var b2_timeToSleep:Float = 0.5;					// half a second
	/**
	* A body cannot sleep if its linear velocity is above this tolerance.
	*/
	public static var b2_linearSleepTolerance:Float = 0.01;			// 1 cm/s
	/**
	* A body cannot sleep if its angular velocity is above this tolerance.
	*/
	public static var b2_angularSleepTolerance:Float = 2.0 / 180.0 * B2Settings.b2_pi;	// 2 degrees/s
